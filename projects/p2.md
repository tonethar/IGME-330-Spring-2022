...
|    - For a high impact score on an Audio Visualizer, you should be following the best practices listed here: [AV Tips](./p2-overview-and-tips.md#iv-av-tips) | *(-5 each)* |
