...
- XML syntax rules:
  ...
  - N.B. - don't worry about having to remember the XML declaration at the top of an XML file! THis is because it is not required if the document is either UTF-8 or UTF-16
- JSON syntax rules:
