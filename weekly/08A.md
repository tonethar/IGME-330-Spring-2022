...
## III. Project 1 Questions

- https://github.com/tonethar/IGME-330-Spring-2022/blob/main/projects/p1-final.md

### III-A. "All your web components must take a parameter"

- They must hav a parameter that is passed in via attribute(s), slot(s) and/or as an object property
