...
- `localStorage` stuff:
  ...
  - **app.js** links to this file. On this page we have functionalotuy that allows the user to change the title of the web site, and well as add items to the favorites list
  - **favorites.html** links to 
