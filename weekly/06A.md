...
- Bulma stuff
  - Both pages:
    ...
    - `<hotdog-footer>` web component - notes that it uses `<slot>`s and the code contains only a constructor, as it does not need any other lifecycle or helper methods
  - **app.html**
