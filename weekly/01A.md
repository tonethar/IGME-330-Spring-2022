...
- Project 1
  ...
  - Ajax - i.e. *Downloading data in the background and updating a web page without having to refresh the beowser*
  ...
  - Storing app data *locally* with [`window.localStorage`](https://developer.mozilla.org/en-US/docs/Web/API/Window/localStorage)
    - 235 Review --> [Web Apps 9 - WebStorage API](https://github.com/tonethar/IGME-230-Master/blob/master/notes/web-apps-9.md)
  - *Cloud data storage* with [Firebase](https://firebase.google.com/) and/or *Mapping* with [Mapbox](https://www.mapbox.com/)
