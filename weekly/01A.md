...
## I. Overview
Welcome to IGME-330 *Rich Media Web Application Development I*. In this "creative coding" course you will be building on top of IGME-230/235 and constructing compelling interactive experiences that can be viewed over the web. You will also be learning about how to build more robust and modular web software by utilizing more features of JavaScript ES6, Web Components and CSS frameworks such as Bulma.
...
- Project 1 - *VanillaJS App of Awesomeness*
  ...
  - [Bulma](https://bulma.io/) - CSS framework for building responsive web interfaces
  - Ajax - i.e. *downloading data in the background and updating a web page without having to refresh the browser*
    - [XHR](https://developer.mozilla.org/en-US/docs/Web/API/XMLHttpRequest) - 235 review --> [Web Apps 10 - Web Services](https://github.com/tonethar/IGME-230-Master/blob/master/notes/web-apps-10.md)
    - [Fetch API](https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API) & [Promises](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise)
  - *Locally* stored app data utilizing [`window.localStorage`](https://developer.mozilla.org/en-US/docs/Web/API/Window/localStorage)
    - 235 Review --> [Web Apps 9 - WebStorage API](https://github.com/tonethar/IGME-230-Master/blob/master/notes/web-apps-9.md)
  - *Remotely* stored "cloud" data storage with [Firebase](https://firebase.google.com/) and/or *Mapping* with [Mapbox](https://www.mapbox.com/)
- Project 2 - *Interactive Sandbox App of Awesomeness*
  ...
  - [ml5js.org](https://ml5js.org/) - "Friendly Machine Learning for the Web"
...
- Don't get us wrong here:
  - we LOVE making apps in Web Frameworks like Vue.js (which we will demo later on in this course) and ReactJS (which is covered in Rich Media II IGME-430)
...
- Slack
  - You've already been added to our Slack workspace:
    ...
    - The direct link to our workspace is:  https://rit-igme-330-2221.slack.com
  ...
  - Other stuff:
    ...
    - DO ask questions about concepts, homework clarifications, etc
    - DO share links or examples that seem useful
    ...
    - when *answering* questions:
      ...
      - do NOT do someone's work for them (this ruins the learning process).
      - do NOT explain exactly how to solve a problem (this ruins the learning process).
...
* [IGME-330 - Course Code Style Requirements](https://github.com/tonethar/IGME-330-Spring-2022/blob/main/projects/330-code-style.md)
* Also:
