...
- Project 1
  ...
  - [XHR](https://developer.mozilla.org/en-US/docs/Web/API/XMLHttpRequest) (330 review --> [10 - Web Services](https://github.com/tonethar/IGME-230-Master/blob/master/notes/web-apps-10.md)) & [Fetch API](https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API)
  - Storing app data *locally* with [`window.localStorage`](https://developer.mozilla.org/en-US/docs/Web/API/Window/localStorage) (330 Review --> [9 - WebStorage API](https://github.com/tonethar/IGME-230-Master/blob/master/notes/web-apps-9.md)
